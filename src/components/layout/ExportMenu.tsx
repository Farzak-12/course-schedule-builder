...
import { IcsExportDialog, type IcsExportOptionsInput } from './IcsExportDialog'
...
export function ExportMenu() {
  ...
  function handleIcsConfirm(options: IcsExportOptionsInput) {
    setIcsDialogOpen(false)
    const enrolled = getEnrolledSections(courses, picks)
    const ics = buildIcsCalendar(enrolled, options)
  ...
  return (
    <>
      ...
      {icsDialogOpen && <IcsExportDialog onCancel={() => setIcsDialogOpen(false)} onConfirm={handleIcsConfirm} />}
    </>
  )
}
